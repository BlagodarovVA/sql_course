...
select count(NVL(commission_pct, 0)) from employees;    -- ����� ��������� ��� ��������, null �������� �� 0
select count(*) from employees where salary > 7000; 
select count(ALL commission_pct) from employees;        -- ALL ������������� �� ���������, �� ������
...
-- GROUP BY
select department_id, count(*), min(salary) from employees  -- count ���������� ����� ��� ������ ������
    group by department_id 
    order by 1, 2;                                          -- order by 1,2���������� �� 1 � 2 ��������
...
select round(sum(avg(length(upper(last_name))))) from employees group by department_id; -- ����� ��������� ��������� � ����� �������
...
select first_name, last_name, salary, department_name, department_id, manager_id
    from employees natural join departments;    -- ����������� �� 2 ��������, �.�. ��� ���� � ����� ��������
...
select * from countries;
select * from regions 
    join countries using (region_id);     -- ���������� NATURAL JOIN, �� �����, �.�. �������, �� ������ ������� �����������
...
select first_name, last_name, jh.job_id, start_date, end_date
    ...
    ON (emp.employee_id = jh.employee_id and emp.department_id = jh.department_id); -- ����������� �� 2 ��������
...
select * from countries;
select * from regions;
select * from countries CROSS JOIN regions;     -- ����������� ��� ������ ������� 1 �� ������ �� 2
...
select job_title from jobs j join employees e       -- ������������ ������� �������� �� ����������
...
select last_name, first_name, salary, job_id from employees
where job_id IN (select job_id from jobs where min_salary > 8000);  -- IN ��� NOT IN
